...
import cz.maderajan.mml.commonutil.UnauthorizedException
...
class PreferencesDataStore(private val dataStore: DataStore<Preferences>) {
    ...
    suspend fun getSpotifyBearerAccessToken(): String = getSpotifyAccessToken()?.let { "Bearer $it" } ?: throw UnauthorizedException()
